...
int main(){
    Graph_FlowNetWorks g11(4);

    g11.AddEdge(0, 1, 20);g11.AddEdge(0, 2, 10);
    g11.AddEdge(1, 2, 5);g11.AddEdge(2, 1, 3);
    g11.AddEdge(1, 3, 10);g11.AddEdge(2, 3, 20);
    
    g11.FordFulkerson(0, 3);    // 指定source為vertex(0), termination為vertex(5)
    return 0;
}